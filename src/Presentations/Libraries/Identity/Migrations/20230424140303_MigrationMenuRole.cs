...
{
    public partial class MigrationMenuRole : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationMenuRole", x => new { x.MenuId, x.RoleId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationMenuRole_Role_RoleId",
                        column: x => x.RoleId,
                        principalSchema: "Identity",
                        principalTable: "Role",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationMenuRole_RoleId",
                schema: "Identity",
